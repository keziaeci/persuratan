                            ...
                            <div class="col-6">
                                <ul class="m-2 p-0">
                                    ...
                                    <li>
                                        ...
                                        <input class="form-control" type="date" name="tanggal_terima" id="tanggal_terima" required value="<?= $srt["tanggal"]; ?>">
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <input class="form-control" type="text" name="asal_surat" id="asal_surat" required value="<?= $srt["asal_surat"]; ?>">
                                    </li>
                                </ul>
                            </div>  
                            <div class="col-6">
                                <ul class="m-2 p-0">
                                    <li>
                                        ...
                                        <input class="form-control" type="text" name="nomor_tanggal_surat" placeholder=".../.../..."id="nomor_tanggal_surat" required value="<?= $srt["nomor_tanggal_surat"]; ?>">
                                    </li>
                                    
                                    <li>
                                        <label class="form-label"  for="perihal">Perihal</label>
                                        <input class="form-control" type="text" name="perihal" id="perihal" required value="<?= $srt["perihal"]; ?>">
                                    </li>
                                    <li>
