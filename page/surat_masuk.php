<?php 
    ...
    $surat = query("SELECT * FROM surat_masuk LIMIT $awalData, $jumlahDataPerHalaman ");
  ...
  <body id="body-pd">
    ...
    <!--Container Main start-->
      <div class="col-12">
        <div class="row">
          <div class="col mt-4">
            <p class="fw-semibold fs-5">Daftar Surat Masuk</p>
                  ...
                  <div class="card-body p-1 m-0 table table-responsive">
                    ...
                    <?php foreach($surat as $row) : ?>
                        <tr>
                            ...
                            <td><?= $row["perihal"]; ?></td>
                            <td>
                                <a class="btn btn-success" href="../assets/file_sm/<?= $row["file_surat"]; ?>" target="_blank">Preview</a>
                            </td>
                            <td>
