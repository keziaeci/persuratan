                        ...
                        <div class="row">
                            <div class="col-6">
                                <ul class="m-2 p-0">
                                    <li>
                                        ...
                                        <input class="form-control" type="date" name="tanggal_pembuatan" id="tanggal_pembuatan" size="" required>
                                    </li>
                                    <li>
                            ...
                            <div class="col-6">
                                <ul class="m-2 p-0">
                                    ...
                                    <br>
                                    <li>
                                        <!-- <label for="submit">Su</label> -->
                                        
                                </ul>
                            </div>
                            <ul>
                                <li>
                                    <button class="btn btn-primary text-light" type="submit" name="submit">Tambah Data</button>
                                </li> <br>
